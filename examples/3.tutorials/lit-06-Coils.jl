...
coil_sens3 = exp.(-π * ((obj.x) .^ 2 / 0.01) .+ (((obj.y) .+ 0.1) .^ 2 / 0.01)) / 60
coil_sens4 = exp.(-π * ((obj.x) .^ 2 / 0.01) .+ (((obj.y) .- 0.1) .^ 2 / 0.01)) / 60
...
coil_sens3 = exp.(-π * ((xq) .^ 2 / 0.01) .+ (((yq') .+ 0.1) .^ 2 / 0.01)) / 60
coil_sens4 = exp.(-π * ((xq) .^ 2 / 0.01) .+ (((yq') .- 0.1) .^ 2 / 0.01)) / 60
